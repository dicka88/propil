...
export default function ModalPicturePicker({ open, toggle, src, inputPictureRef, onRemove, onSave }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex gap-2 justify-end">
        <button className="py-2 px-4 border border-red-200 text-red-500 rounded-md" onClick={onRemove}>
          <HiTrash className="inline mr-4" />
          Remove
        </button>
        <button className="py-2 px-4 text-black border rounded-md" onClick={handleChangePicture}>
